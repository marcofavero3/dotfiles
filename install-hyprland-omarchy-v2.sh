...
# =====================================================
# Script Hyprland OmArchy - VERSÃO 2.0
# Auto-detecção + Proteções + Log
# Autor: Marco Favero
...
cat << "EOF"
╔═══════════════════════════════════════════════════════╗
║     HYPRLAND INSTALLER - ESTILO OMARCHY V2.0         ║
║              Auto-detect User & Hostname              ║
╚═══════════════════════════════════════════════════════╝
EOF
echo -e "${NC}"
...
# FASE 8
print_info "═══ FASE 8/18: Lock Screen ═══"
sudo pacman -S --needed --noconfirm swaylock-effects

# FASE 9
print_info "═══ FASE 9/18: Apps ═══"
sudo pacman -S --needed --noconfirm nemo firefox mpv imv

# FASE 10
print_info "═══ FASE 10/18: Dev Tools ═══"
sudo pacman -S --needed --noconfirm git base-devel wget curl unzip

# FASE 11
print_info "═══ FASE 11/18: YAY ═══"
...
# FASE 18
print_info "═══ FASE 18/18: Configurações ═══"
...
cat > "$HOME_DIR/.config/waybar/config" << 'WAYBAR'
{
    ...
    "hyprland/workspaces": {
        "format": "{icon}",
        "format-icons": {"1": "一", "2": "二", "3": "三", "4": "四", "5": "五"}
    },
...
echo ""
echo "Após reiniciar:"
echo "  1. SDDM login screen"
echo "  2. Digite senha → Hyprland inicia"
echo "  3. SUPER+D = Wofi launcher"
echo ""
